/**making CRUD applicaiton*/
const express = require("express");
/**importing body-parse package
...
/**middleware to help keep track of requests */
 ...
 * put it at the end so it can process it last if it can't find the route*/
app.use((req, res) => {
  res.status(404);
